...
import { getComparator, reformatDate, stableSort, germanDatePresentation } from '../utli/dataConversion.js';
                      ...
                      {headCells.map(el => {
                        return !(el.tableView) ? '' : 
                          <TableCell 
                            ...
                            >
                              {el.id != 'date' ? row[el.id] : germanDatePresentation(new Date(row[el.id]))}
                          </TableCell>; 
                      })
                      }
